    ...
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <a class="layout-topbar-logo" routerLink="/">
                ...
                <img src="{{!layoutService.isDarkTheme() ? '/assets/images/360techx_logo_horizontal_nobg_black.png': '/assets/images/360techx_logo_horizontal_nobg_white.png'}}"  alt="" srcset="" width="80%">
